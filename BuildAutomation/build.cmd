...
MSBuild ..\Spring4Shell.sln /m /nodeReuse:false /t:Clean,Rebuild /p:Configuration=Release,Platform=x86 >%LOG_FILE%
...
signtool sign /f "%bamboo_winsign_pfxfile%" /p "%bamboo_winsign_password%" /fd SHA256 /n "Qualys" /d http://www.qualys.com /tr http://timestamp.digicert.com /td SHA256 /v "%BUILD_OUTPUT%\Spring4Scan.exe"
...
ECHO Building - %BUILD_TARGET%
MSBuild ..\Spring4Shell.sln /m /nodeReuse:false /t:Clean,Rebuild /p:Configuration=Release,Platform=x64 >%LOG_FILE%
SET BUILD_STATUS=%ERRORLEVEL%
